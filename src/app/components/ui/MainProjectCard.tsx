...
export default function MainProjectCard({
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto mb-12">
      ...
      {/* Container */}
      <div className="relative z-10 flex flex-col md:flex-row p-4 overflow-hidden rounded-2xl border border-black dark:border-white bg-white dark:bg-gray-800 transition-all duration-300">
        
        {/* Image */}
        <div className="w-full md:w-1/2 relative overflow-hidden rounded-xl border border-black/10 dark:border-white/10">
          <Image
            src={image}
            alt={title}
            width={600}
